...
export const components = {
    ...
    a: (props: ComponentProps<'a'>) => (
        <Link className="font-medium text-blue-600 underline decoration-blue-600/30 underline-offset-4 hover:decoration-blue-600 transition-all dark:text-blue-400 dark:decoration-blue-400/30 dark:hover:decoration-blue-400" {...props} href={props.href || '#'} />
    ),
